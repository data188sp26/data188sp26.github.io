...
**Important:** In this course, we will use [Edstem](https://TODO/add/link) to post announcements and important information.
**It is the student's responsibility to actively monitor the Ed for any important announcements.**

**Useful course links:**
- bCourse: [link](https://TODO/add/link)
- Ed: [link](https://TODO/add/link)
- Gradescope: [link](https://TODO/add/link)
...
provided via the bCourses ["Media Gallery"](https://TODO/add/link). Students are responsible for all lecture content.
